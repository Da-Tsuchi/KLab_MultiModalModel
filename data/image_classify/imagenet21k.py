...
class ImageNet21kDatasetLoader(DatasetLoader):
    def __init__(self, args, data_dir='/data01/imagenet_21k/', resize=256, src_tokenizer=None, tgt_tokenizer=None, mask_probability=0.15,phase="train"):
        super().__init__()
        # modeに基づいて適切なtsvファイルの名前を決定
        tsv_filename1 = f"img_{phase}_256fix.tsv"
        tsv_path1 = os.path.join(data_dir, tsv_filename1)

        tsv_filename2 = f"img_{phase}_256fix.tsv"
